...
[wxID_PANEL1, wxID_PANEL1BUTTON1, wxID_PANEL1BUTTON2, wxID_PANEL1BUTTON3, 
 ...
 wxID_PANEL1STATICTEXT4, wxID_PANEL1STATICTEXT5
...
class OtherPanel(wx.Panel):
    def _init_coll_gridBagSizer1_Items(self, parent):
        ...
        parent.AddWindow(self.staticText3, (7, 1), border=0, 
              flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, span=(1, 2))
        parent.AddWindow(self.textCtrl3, (7, 3), border=0, flag=wx.EXPAND,
              span=(1, 3))
        parent.AddWindow(self.button3, (7, 6), border=0, flag=0, span=(1, 1))
        parent.AddWindow(self.staticText5, (8, 1), border=0, 
              flag=wx.ALIGN_CENTER, span=(1,7))
