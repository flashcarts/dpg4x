...
# Updated: 2011-feb-27 Tomas Aronsson
...
!define MPLAYER_REV 32735
!define MPLAYER MPlayer-p3-svn-${MPLAYER_REV}
!define MPLAYER7Z dependencies\${MPLAYER}.7z
# Direct downloading from SourceForge seems very tricky due to redirects and HTML pages
# inetc fails unless pointing directly to a specific download server, too fragile?
!define MPLAYER_URL "http://ovh.dl.sourceforge.net/project/mplayer-win32/MPlayer%20and%20MEncoder/revision%20${MPLAYER_REV}/${MPLAYER}.7z"
...
!define MULTIUSER_INSTALLMODE_INSTDIR dpg4x
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_KEY "${REGKEY}"
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_VALUE "Path"

# MUI Symbol Definitions
!define MUI_ICON dpg4x.ico
!define MUI_WELCOMEFINISHPAGE_BITMAP "installer_dpg4x.bmp"
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "installer_dpg4x.bmp"
!define MUI_STARTMENUPAGE_REGISTRY_ROOT HKLM
!define MUI_STARTMENUPAGE_REGISTRY_KEY ${REGKEY}
!define MUI_STARTMENUPAGE_REGISTRY_VALUENAME StartMenuGroup
!define MUI_STARTMENUPAGE_DEFAULTFOLDER dpg4x
...
OutFile dpg4x-2.1_setup.exe
Caption "$(^Name) ${VERSION}"
InstallDir $PROGRAMFILES\dpg4x
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion 2.1.0.0
VIAddVersionKey ProductName dpg4x
...
Section -post SEC0001
    ...
    CreateShortCut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" "$INSTDIR\dpg4x.exe" "" "$INSTDIR\dpg4x.exe"
...
Section /o -un.Main UNSEC0000
    ...
    Delete /REBOOTOK $INSTDIR\wx*.dll
    ...
    # TBD: check if mplayer was installed
