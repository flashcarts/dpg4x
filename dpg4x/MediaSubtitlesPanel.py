...
#----------------------------------------------------------------------------
# Name:         MediaSubtitlesPanel.py
# Purpose:      Panel with per-media subtitle options.
#
# Author:       Marc P. Davignon
#
# Created:
# RCS-ID:       $Id: MediaSubtitlesPanel.py $
...
[wxID_PANEL1, wxID_PANEL1BUTTON1, wxID_PANEL1BUTTON2,
 ...
 wxID_PANEL1CHOICE2, wxID_PANEL1BUTTON7, wxID_PANEL1BUTTON8, wxID_PANEL2
] = [wx.NewId() for _init_ctrls in range(16)]

class MediaSubtitlesPanel(wx.Panel):
    def _init_coll_gridBagSizer1_Items(self, parent):
        ...
        # (old comment out) parent.AddSpacer(wx.Size(200, 8), (0, 3), border=0, flag=0, span=(1, 3))
        ...
        parent.Add(self.panel2, (12, 1), border=0, flag=0, span=(1, 4))
    ...
    def __init__(self, parent):
        ...
        if Globals.which('iconv'):
            iconvOut = subprocess.Popen(
                ['iconv', '-l'], stdout=subprocess.PIPE,
